<div class="index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $asr5500_summary['Asr5500Summary']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $asr5500_summary['Asr5500Summary']['id']))); ?>
		</td>
	</tr>
	<?php endforeach; ?>
	</tbody>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Excel出力'), array('action' => 'excel2007')); ?></li>
		<!--
		<li><?php echo $this->Html->link(__('PDF出力GETパラメーター'), array('action' => 'menu_download_pdf')); ?></li>
		-->
		<li><?php echo $this->Html->link(__('PDF出力'), array('action' => 'menu_download_pdf_link')); ?></li>
		<li><?php echo $this->Html->link(__('Mail送信'), array('controller'=>'emails' , 'action' => 'send')); ?></li>
	</ul>
</div>
